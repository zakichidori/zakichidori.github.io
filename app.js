...
const sideShoutout = document.querySelector(".side-shoutout");
const thunderboltArt = document.getElementById("thunderboltArt");
const thunderboltArtLeft = document.getElementById("thunderboltArtLeft");
const thunderboltChidoriRight = document.getElementById("thunderboltChidoriRight");
const thunderboltChidoriLeft = document.getElementById("thunderboltChidoriLeft");
...
function applyTheme(theme) {
  ...
  sideShoutout.textContent = "raseem♥ THE GOAT";
  sideShoutout.style.display = "block";
  thunderboltArt.style.display = "none";
  thunderboltArtLeft.style.display = "none";
  thunderboltChidoriRight.style.display = "none";
  thunderboltChidoriLeft.style.display = "none";

  if (theme === "r4seem") {
    siteKicker.textContent = "raseem theme";
    siteTitle.textContent = "\"you dont know how far you can fly until you spread your wings.\"";
    siteSubtext.textContent = "";
    heroLogo.src = "https://i.ibb.co/QL0QWhn/image.png";
    heroLogo.alt = "Raseem theme image";
    sideShoutout.style.display = "none";
    thunderboltArt.style.display = "block";
    thunderboltArtLeft.style.display = "block";
    return;
  }
  ...
  thunderboltChidoriRight.style.display = "block";
  thunderboltChidoriLeft.style.display = "block";
}

const AUTH_KEY = "chidorihub_authed";

function unlockSite() {
  if (passwordInput.value.trim().toLowerCase() === "bashir") {
    // Save auth so they never see this screen again on this browser
...
function checkRemembered() {
  try {
    ...
    // localStorage blocked (e.g. strict privacy mode) — just show the lock screen normally
  }
}
