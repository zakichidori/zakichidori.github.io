...
const chidoriThunderboltRight = document.getElementById("chidoriThunderboltRight");
const chidoriThunderboltLeft = document.getElementById("chidoriThunderboltLeft");
...
function applyTheme(theme) {
  ...
  chidoriThunderboltRight.style.display = "none";
  chidoriThunderboltLeft.style.display = "none";
  ...
  chidoriThunderboltRight.style.display = "block";
  chidoriThunderboltLeft.style.display = "block";
